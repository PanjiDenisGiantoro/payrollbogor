...
?>
        ...
        <div class="col-12">
          ...
          <!-- /.card -->
            ...
            <div class="card-header">
              <h3 class="card-title">Data Resume Perorang SIIHA</h3>
  ...
  <form method="POST" action="">
        <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control"name="nama" id="nama" placeholder="nama"style="width: 60%;" onkeyup ="isi_otomatis()" >
                    </div>
                  </div>
                 <div class="form-group row">
                    <label for="namajabatan" class="col-sm-2 col-form-label">jabatan</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control"name="namajabatan" id="namajabatan" placeholder="namajabatan"style="width: 60%;"  >
                    </div>
                  </div>
                                 <div class="form-group row">
                    <label for="bulan" class="col-sm-2 col-form-label">Bulan</label>
                    <div class="col-sm-10">
                                         <select name="bulan" class="form-control-sm form-control"style="width: 60%;">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                       <select name="tahun"  class="form-control-sm form-control"  style="width: 400px">
                    ...
                    <button id="search" name="search" class="btn btn-primary"  >Submit</button>
                          ...
                          <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">cetak data resume</h5>
              </div>
  ...
  ?>
<form method="POST" action="cetakresume.php">
        <div class="card-body">
                  <div class="form-group row">
                    <label for="nama1" class="col-sm-2 col-form-label">nama</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control"name="nama1" id="nama1" placeholder="nama"style="width: 60%;" onkeyup ="isi_otomatis1()" >
                    </div>
                  </div>
                 <div class="form-group row">
                    <label for="namajabatan1" class="col-sm-2 col-form-label">jabatan</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control"name="namajabatan1" id="namajabatan1" placeholder="namajabatan"style="width: 60%;"  >
                    </div>
                  </div>
                                 <div class="form-group row">
                    <label for="bulan" class="col-sm-2 col-form-label">Bulan</label>
...
$(function() {
  ...
  function isi_otomatis(){
                ...
                success:function (data) {
                    var json = data
                    obj = JSON.parse(json);
                    $('#namajabatan').val(obj.departemen);
                },
              ...
              function isi_otomatis1(){
                ...
                success:function (data) {
                    var json = data
                    obj = JSON.parse(json);
                    $('#namajabatan1').val(obj.departemen);
                },
                error:function(error){
                  console.log(error);
                }
...
$sql123 = mysqli_fetch_array(mysqli_query($konek,"SELECT count(masuk < awaltugas) as Very FROM kehadirans WHERE nama = '$nama' and tanggal like ('$tahun-$bulan-%') AND masuk !='00:00:00' and bolos=''"));
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [
              ...
              <?php 
              // $s = $jumlah_laki['namaa'] - $jumlah_perempuan['nam'] -  $sakit['a'] -  $izin['b'];
          ...
          echo round($jumlah_laki['namaa'] / $persen1['namaa'] * 100);
          ...
          echo round($jumlah_perempuan['nam'] / $persen1['namaa'] * 100);
          $jj1 = $jumlah_perempuan['nam'];
          ?>,
               <?php 
          $sakit =  mysqli_fetch_array(mysqli_query($konek,"SELECT count(nama) as a FROM kehadirans WHERE nama ='$nama1' AND bolos = 'sakit'and tanggal like ('$tahun1-$bulan1-%')"));
          echo  round($sakit['a'] / $persen1['namaa'] * 100);


          $jj2 = $sakit['a'] ;
          ?>,
                 <?php 
          $izin =  mysqli_fetch_array(mysqli_query($konek,"SELECT count(nama) as b FROM kehadirans WHERE nama ='$nama1' AND bolos = 'izin'and tanggal like ('$tahun1-$bulan1-%')"));
          echo round($izin['b'] / $persen1['namaa'] * 100);
          ...
          $jj3 =  $izin['b'] ;
             ...
             $lembur = mysqli_fetch_array(mysqli_query($konek,"SELECT count(jumlahjam) as jumlahjam FROM lemburs WHERE namaKaryawan ='$nama1' and tglLembur like ('$tahun1-$bulan1-%')"));
               $libur = mysqli_fetch_array(mysqli_query($konek,"SELECT count(bolos) as libur FROM kehadirans WHERE nama ='$nama1' and bolos='libur 'and tanggal like ('$tahun1-$bulan1-%')"));
...
<td align='center'>$libur[libur]</td>
    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          echo round(($jumlah_laki1['NI'] + $boloss['boloss']) / $persen1['namaa'] * 100)  ; 
          $teee = ($jumlah_laki1['NI'] + $boloss['boloss']);
          ?>, 
          <?php 
          ...
          echo round($jumlah_perempuan1['good'] / $persen1['namaa'] * 100)  ; 
          $gooo =  $jumlah_perempuan1['good'] ;
          ?>,
               <?php 
          $sakit1 = mysqli_fetch_array(mysqli_query($konek,"SELECT count(masuk < awaltugas) as Very FROM kehadirans WHERE nama = '$nama' and tanggal like ('$tahun-$bulan-%') AND masuk !='00:00:00' and bolos=''"));
          echo round($sakit1['Very'] / $persen1['namaa'] * 100 ) ; 
...
<?php
  // echo ($jumlah_laki1['NI'] + $boloss['boloss']) / $persen1['namaa'] * 100  
?>
  <?php
