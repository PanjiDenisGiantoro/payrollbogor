        ...
        <div class="col-12">
          ...
          <!-- /.card -->
            ...
            <div class="card-header">
              <h3 class="card-title">Data pinjaman Lain lain Karyawan STIFFIN</h3>
            ...
            <div class="card">
              ...
              <div class="card-body">
              <a href="lainkaryawan.php?view=tambah" class="btn btn-primary" >Tambah Data pinjaman Lain lain Karyawan</a>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <!-- /.card -->
            ...
            <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Data  pinjaman Lain lain  STIFFIN</h3>
...
"));
$sq = $sql1['namalengkap'];
$sql = mysqli_query($konek,"SELECT * from lainlains where namaKaryawan='$sq'");
$no=1;
...
<a class='btn btn-danger btn-sm fa fa fa-eraser' href='aksi_lainkaryawan.php?act=del&id=$d[id]'></a>
</td>
</tr>";
$no++;
}
      ...
      <div class="row">
        <div class="col-10">
          ...
          <!-- /.card -->
            ...
            <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Tambah Data pinjaman lain lain </h3>
...
<form method="post" action="aksi_lainkaryawan.php?act=insert" class="form-horizontal">
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
