...
$id = $_POST['id'];
	...
	$hapus = mysqli_query($konek,"delete from documentkaryawan where id = '$_GET[id]'");
	if($hapus){
		
		header('location:documentkaryawan.php?e=sukses');
	}else{
		header('location:documentkaryawan.php?e=gagal');
	}
}
}
?>