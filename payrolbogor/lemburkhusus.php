  ...
  <section class="content">
        ...
        <div class="col-12">
          ...
          <!-- /.card -->
            ...
            <div class="card-header">
              <h3 class="card-title">Data Lembur Lembur khusus Karyawan SIIHA</h3>
            ...
            <div class="card">
              ...
              <div class="card-body">
              <a href="lemburkhusus.php?view=tambah" class="btn btn-primary" >Tambah Data Lembur Lembur khusus Karyawan</a>
     ...
     <!--    <td>
            ...
            <div class="card">
              ...
              <div class="card-body">
                  <a href="laporankasbonall.php" class="btn btn-success" target="_blank" >cetak  Lembur Lembur khusus keseluruhan</a>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <!-- /.card -->
            ...
            <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Data  Lembur Lembur khusus  SIIHA</h3>
...
<?php
$sql = mysqli_query($konek,"SELECT * from lemburkhusus");
$no=1;
...
<a class='btn btn-warning btn-sm fas fa-pencil-alt' href='lemburkhusus.php?view=edit&id=$d[id]' >edit</a>
<a class='btn btn-danger btn-sm fas fa-trash' href='aksi_lemburkhusus.php?act=del&id=$d[id]'>hapus</a>
</td>
</tr>";
$no++;
}
...
<form method="post" action="aksi_lemburkhusus.php?act=insert" class="form-horizontal">
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                     <label for="tgl" class=" form-control-label">Tanggal lemburkhusus</label>
        <input type="date"name="tgl" id="tgl"  class="form-control"  value="<?php echo date('Y-m-d') ?>"/>
                  ...
                  <button type="submit" class="btn btn-primary" value="Simpan" >Submit</button>
                    ...
                    <a class="btn btn-danger" href="lemburkhusus.php">kembali</a> 
                  </div>
                </form>
...
break;
case "edit";
$sqlEdit = mysqli_query($konek,"select * from lemburkhusus where id='$_GET[id]'");
        ...
        <div class="col-10">
          ...
          <!-- /.card -->
            ...
            <!-- general form elements disabled -->
              ...
              <!-- /.card-header -->
              <div class="card-body">
         <form method="post" action="aksi_lemburkhusus.php?act=update" class="form-horizontal">
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
