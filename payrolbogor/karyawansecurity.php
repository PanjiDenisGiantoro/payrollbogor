  ...
  <section class="content">
      <div class="row">
        <div class="col-12">
          ...
          <!-- /.card -->
            ...
            <div class="card-header">
              <h3 class="card-title">Data Karyawan Security SIIHA</h3>
        ...
        <td>
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Import Data Security</h5>
              </div>
              <div class="card-body">
...
$sql = mysqli_query($konek,"select * from karyawans where departemen = 'Security' and nama='$bagian'");
}else{
  $sql = mysqli_query($konek,"select * from karyawans where departemen='Security'");
}
$no=1;
$da = date('Y')+1;
...
<a class='btn btn-warning btn-sm fas fa-pencil-alt' href='karyawansecurity.php?view=edit&id=$d[id]'>edit</a></td>
<td width='2px' ><a class='btn btn-danger btn-sm fas fa-trash' href='aksi_karyawansecurity.php?act=del&id=$d[id]'>hapus</a></td>
              ...
              <div class="card-body">
                ...
                <br>
                  ...
                  <button type="submit" class="btn btn-primary" value="Simpan" >Submit</button>
                    ...
                    <a class="btn btn-danger" href="karyawansecurity.php">kembali</a> 
                  </div>
                </form>
          ...
          <!-- /.card -->
            ...
            <!-- general form elements disabled -->
              ...
              <div class="card-body">
                ...
                <form action="aksi_karyawansecurity.php?act=kel" method="post" class="form-horizontal">
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
